      ...
      <div className="mb-8 rounded-2xl bg-gradient-to-br from-zinc-900 via-zinc-900 to-zinc-800 px-4 py-5 sm:px-7 sm:py-7 text-white shadow-xl">
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
          ...
          <div className="flex gap-2">
            ...
            {totalBooked > 0 && (
              <a href={`/api/workshops/${workshop.id}/bookings-csv`} download>
                <Button
                  size="sm"
                  className="rounded-full bg-zinc-700 text-white hover:bg-zinc-600 shadow-lg transition-all hover:-translate-y-0.5"
                >
